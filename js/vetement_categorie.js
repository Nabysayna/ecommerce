$(document).ready(function(){
	...
	$.ajax({
          	url : 'script_server/recupere_categorie_vetement.php',
          	type :'post',
          	dataType : 'json',
      ...
      $('#button').on('click',function(){
		  var data=$('#search').val().split(' ');
                  if(data=!""){
                    $.ajax({
                        url : '../script_server/trait_recherche.php',
                        data :'designation='+data[0]+'&description='+data[1],
                        dataType :'text',
